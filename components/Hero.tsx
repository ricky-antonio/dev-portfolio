            ...
            <div className="flex justify-center relative my-20 z-10">
                <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                    <h2 className="uppercase">
                        Building engaging web experiences with purpose
                    </h2>
                    <TextGenerateEffect
                        className="text-center text-[40px] md:text-5xl lg:text-6xl"
                        words="Passionate Front-End Software Engineer specializing in React"
                    />
                    <p className="text-center md:tracking-wider mt-6 text-sm md:text-lg lg:text-2xl">
                        Crafting thoughtful designs for seamless user
                        experiences
                    </p>
                    <a href="#about">
                        <MagicButton
