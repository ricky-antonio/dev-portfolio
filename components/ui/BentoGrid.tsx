...
export const BentoGridItem = ({
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("myemail@email.com")
        ...
        >
            <div className={`${id === 6 && "flex justify-center"} h-full`}>
                ...
                >
                    ...
                    {id === 2 && <GridGlobe />}
                    {id === 3 && (
                        <div className="flex gap-3 lg:gap-5 w-fit absolute right-3 lg:right-3">
                            <div className="flex flex-col gap-3 lg:gap-8">
                                {["React", "Javascript", "PhP"].map((item) => (
                                    <span
                                        key={item}
                            ...
                            <div className="flex flex-col gap-3 lg:gap-8">
                                <span className="py-5 px-3 rounded-lg text-center bg-[#10132E]" />
                                {["Python", "Tailwind", "NodeJs"].map((item) => (
                                    <span
                                        key={item}
                                        className="py-2 lg:py4 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                                    >
